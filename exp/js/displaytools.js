...
function testStim(lineupImgs,targDiv,condition, lineupname, targID){
...
this.init=function(){
    ...
    if(condition=="nominate") lineupTable+="<h3>Please indicate which of these faces you saw in the study phase, or 'absent' if none of them were shown.</h3>";
    lineupTable+="</td>";
    lineupTable+="</tr><tr>";

   
    for(var i = 0;i<lineuplength;i++){
	lineupTable+="<td><canvas id='canvas"+i+"' height='"+canvasheight+"' width='"+canvaswidth+"'></canvas></td>";
    }
    lineupTable+="</tr>";
    ...
    for(var i=0;i<lineupImgs.length;i++)drawPic("blocky.jpg","canvas"+i);
